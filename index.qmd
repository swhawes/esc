...
# Convert the table to HTML and add CSS for scrolling
html_table <- as.character(formatted_table_setting)
html_table_with_scroll <- paste0(
...
#write(html_table_with_scroll, file = "formatted_table.html")
...
### Service Type Histograms by Cohort (Temp Table)
