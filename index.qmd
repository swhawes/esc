...
### Cohort Table {.tabset .tabset-fade .tabset-pills}

::: blue

> **This table shows xxxxx**
...
# Step x: Create and format the table using kable and kableExtra
formatted_table <- contingency_df %>%
  kable("html", col.names = c("Index", "Cohort", "Count", "Mean(SD)", "High", "Low", "Moderate", "Very High")) %>%
